...
extern void
   ansi_transform_express P( (char *, size_t)),
   ...
   newmacro P( (int)),
   notitlebar P( (void)),
   not_replying_transform_express P( (char *, size_t)),
   open_browser P( (void)),
   opentmpfile P( (void)),
   otherinfo P( (void)),
   ...
   readbbsrc P( (void)),
   replycode_transform_express P( (char *, size_t)),
   replymessage P( (void)),
   reprint_line P( (void)),
   resetterm P( (void)),
   run P( (char *, char *)),
...
extern int
   ...
   cap_putchar P( (int)),
   cap_puts P( (const char *)),
   checkfile P( (FILE *)),
   colorize P( (const char *)),
   delete_queue P( (queue *)),
   deletefile P( (const char *)),
   ExtractNumber P( (const char *)),
   fsortcmp P( (const friend *const *, const friend *const *)),
   fsortcmp_void P( (const void *, const void *)),
   fstrcmp P( (const char *, const friend *)),
   fstrcmp_void P( (const void *, const void *)),
   getkey P( (void)),
   getwindowsize P( (void)),
   inkey P( (void)),
   is_automatic_reply P( (const char *)),
   is_queued P( (const char *, queue *)),
   more P( (int *, int)),
   net_printf P( ( const char *, ... ) ),
   net_putchar P( (int)),
   net_puts P( (const char *)),
   newkey P( (int)),
   pop_queue P( (char *, queue *)),
   prompt P( (FILE *, int *, int)),
   push_queue P( (const char *, queue *)),
   ...
   sortcmp P( (char **, char **)),
   sortcmp_void P( (const void *, const void *)),
