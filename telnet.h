...
/*
 * Generic telnet protocol defines, along with the client-specific protocol
 * spoken between the ISCA BBS and a connected client. Changes here must remain
 * compatible with the BBS implementation.
 */
#ifndef TELNET_H_INCLUDED
#define TELNET_H_INCLUDED

#define IAC 255  // interpret as command:
#define DONT 254 // do not use option
#define DO 253   // use option
#define WONT 252 // will not use option
#define WILL 251 // will use option
